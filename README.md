...
Rouschev, T. (2026). *ZeroPoint Node* (Version 1.5.2) [Computer software]. https://doi.org/10.5281/zenodo.22178675
...
Package: **`zeropoint-node@1.5.2`** · owner `ceccec` · git tag `v1.5.2`
