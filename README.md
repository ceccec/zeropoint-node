...
| | |
| --- | --- |
| exported values reachable from no law at all | **1415 of 1770** |
...
reports that 148 of 1311 exported functions have never been called by anything —
...
Rouschev, T. (2026). *ZeroPoint Node* (Version 1.5.5) [Computer software]. https://doi.org/10.5281/zenodo.22178675
...
Package: **`zeropoint-node@1.5.5`** · owner `ceccec` · git tag `v1.5.5`
