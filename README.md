...
| Lean statements the kernel accepts | 50 of 74 |
| of those, resting on **no axioms at all** | 42 |
...
| | |
| --- | --- |
| proof kernel | Lean 4 — 50 of 74 statements accepted, dependency sets recorded per theorem |
