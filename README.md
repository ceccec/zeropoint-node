...
| | |
| --- | --- |
| exported values reachable from no law at all | **1413 of 1754** |
| exported literal constants held by nothing | **49 of 57** |
| constants forced by at least one law | 8 |
| seal predicates that are *pinned* rather than forced | 3 of 36 |
...
And the apparatus around them, which is arguably the point: 36 theorems
...
reports that 148 of 1295 exported functions have never been called by anything —
...
pq-crystals reference cases; 36 seals that each decide something finite and are
...
Rouschev, T. (2026). *ZeroPoint Node* (Version 1.5.1) [Computer software]. https://doi.org/10.5281/zenodo.22178675
