...
| seal predicates that are *pinned* rather than forced | 3 of 35 |
...
And the apparatus around them, which is arguably the point: 35 theorems
...
pq-crystals reference cases; 35 seals that each decide something finite and are
