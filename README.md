...
| seal predicates that are *pinned* rather than forced | 6 of 34 |
...
And the apparatus around them, which is arguably the point: 34 theorems
...
pq-crystals reference cases; 34 seals that each decide something finite and are
