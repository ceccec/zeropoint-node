...
exports.COIL_PATTERNS = [
    {
        ...
        weight: 1.0,
        resonanceFactors: ['infinite_potential', 'source_creation', 'emptiness_fullness']
    },
    {
        name: 'toroidal',
    ...
    },
    {
        ...
        weight: 0.8,
        resonanceFactors: ['harmonic_resonance', 'divine_proportion', 'natural_growth']
    },
    {
        name: 'consciousness',
        ...
        weight: 0.8,
        resonanceFactors: ['consciousness_level', 'awareness_patterns', 'spiritual_cycles']
    },
    {
        name: 'aperture',
        ...
        weight: 0.9,
        resonanceFactors: ['transformation_point', 'gateway_void', 'singularity_center']
    },
    {
        name: 'uroboros',
...
function getCoilContext(name) {
    ...
    return pattern?.context || 'This pattern embodies a fundamental aspect of coil consciousness.';
}
/**
...
//# sourceMappingURL=CoilSystem.js.map