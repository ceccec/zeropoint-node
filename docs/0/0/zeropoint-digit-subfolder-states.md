# ZeroPoint Digit Subfolder States: Next States Defined
...
### Digit 2: Duality Consciousness (`src/2/`)
**Next States Defined:**
...
### Digit 7: Mystery Consciousness (`src/7/`)
**Next States Defined:**
