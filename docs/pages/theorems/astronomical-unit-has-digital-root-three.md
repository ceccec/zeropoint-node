...
```lean
theorem astronomical_unit_has_digital_root_three :
  dr 149597870700 = 3
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:381`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L381) |
