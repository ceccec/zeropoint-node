...
```lean
theorem base_frequency_has_digital_root_nine :
  dr 432 = 9
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:162`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L162) |
