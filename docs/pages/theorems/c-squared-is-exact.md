...
```lean
theorem c_squared_is_exact :
  299792458 * 299792458 = 89875517873681764
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:414`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L414) |
