...
```lean
theorem dr_invariant_under_nine :
  ∀ n ∈ List.range 50, dr (n + 1) = dr (n + 10)
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:64`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L64) |
