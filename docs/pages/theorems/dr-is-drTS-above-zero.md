...
```lean
theorem dr_is_drTS_above_zero :
  ∀ n ∈ List.range 60, n ≠ 0 → dr n = drTS n
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:54`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L54) |
