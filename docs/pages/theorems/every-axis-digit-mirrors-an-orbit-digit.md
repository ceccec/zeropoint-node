...
```lean
theorem every_axis_digit_mirrors_an_orbit_digit :
  ∀ d ∈ axis, tv d ∈ orbit
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:179`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L179) |
