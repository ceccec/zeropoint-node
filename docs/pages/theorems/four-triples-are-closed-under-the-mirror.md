...
theorem four_triples_are_closed_under_the_mirror :
  triples.filter closedUnderMirror = [[1, 5, 9], [2, 5, 8], [3, 5, 7], [4, 5, 6]]
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:471`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L471) |
