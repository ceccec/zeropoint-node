...
theorem light_leaves_a_null_interval :
  ∀ t ∈ List.range 40, 299792458 * 299792458 * (t * t) = (299792458 * t) * (299792458 * t)
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:409`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L409) |
