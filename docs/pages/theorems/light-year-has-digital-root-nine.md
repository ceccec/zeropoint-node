...
```lean
theorem light_year_has_digital_root_nine :
  dr 9460730472580800 = 9
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:377`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L377) |
