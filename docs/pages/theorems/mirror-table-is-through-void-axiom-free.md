...
theorem mirror_table_is_through_void_axiom_free :
  nonzero.all (fun d => (affineTable 8 1).getD (d % 9) 0 == tv d % 9) = true
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:304`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L304) |
