...
theorem no_triple_is_closed_under_both_maps :
  triples.filter (fun t => closedUnderDoubling t && closedUnderMirror t) = []
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:478`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L478) |
...
- [there are eighty four triples](/pages/theorems/there-are-eighty-four-triples)
