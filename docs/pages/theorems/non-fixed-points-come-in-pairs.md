...
theorem non_fixed_points_come_in_pairs :
  (digits.filter (fun d => tv d != d)).length % 2 = 0 ∧ (digits.filter (fun d => swap12 d != d)).length % 2 = 0
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:266`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L266) |
