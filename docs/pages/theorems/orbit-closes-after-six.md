...
```lean
theorem orbit_closes_after_six :
  ∀ d ∈ orbit, dbl (dbl (dbl (dbl (dbl (dbl d))))) = d
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:68`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L68) |
