...
```lean
theorem swap12_is_an_involution :
  ∀ d ∈ digits, swap12 (swap12 d) = d
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:255`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L255) |
...
- [being an involution is not enough for harmony](/pages/theorems/being-an-involution-is-not-enough-for-harmony)
...
- [the ten digits are two fixed points and four pairs](/pages/theorems/the-ten-digits-are-two-fixed-points-and-four-pairs)
- [through void fixes only zero and five](/pages/theorems/through-void-fixes-only-zero-and-five)
