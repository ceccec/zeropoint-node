...
theorem the_ten_digits_are_two_fixed_points_and_four_pairs :
  (digits.filter (fun d => tv d == d)).length = 2 ∧ (digits.filter (fun d => tv d != d)).length = 8 ∧ 2 + 4 * 2 = 10
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:193`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L193) |
