...
theorem the_triangles_are_the_residues_mod_three :
  nonzero.filter (fun d => d % 3 == 1) = triangleOne ∧ nonzero.filter (fun d => d % 3 == 2) = triangleTwo ∧ nonzero.filter (fun d => d % 3 == 0) = axis
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:507`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L507) |
