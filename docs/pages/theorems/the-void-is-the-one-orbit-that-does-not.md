...
```lean
theorem the_void_is_the_one_orbit_that_does_not :
  0 + tv 0 = 0
```
...
| | |
| --- | --- |
| source | [`lean/DigitSpace.lean:250`](https://github.com/ceccec/zeropoint-node/blob/main/lean/DigitSpace.lean#L250) |
