...
const missingInteractions = [
  { dir: 'src/7/8', name: 'Consciousness', target: 'Void', ratio: '7/8', multiplier1: { numerator: 1, denominator: 1 }, multiplier2: { numerator: 8, denominator: 7 } },
  { dir: 'src/7/2', name: 'Consciousness', target: 'Vortex', ratio: '7/2', multiplier1: { numerator: 1, denominator: 1 }, multiplier2: { numerator: 6, denominator: 5 } },
  { dir: 'src/7/5', name: 'Consciousness', target: 'Sacred Geometry', ratio: '7/5', multiplier1: { numerator: 1, denominator: 1 }, multiplier2: { numerator: 5, denominator: 4 } },
  { dir: 'src/6/0', name: 'Harmonic Balance', target: 'ZeroPoint', ratio: '6/0', multiplier1: { numerator: 3, denominator: 2 }, multiplier2: { numerator: 0, denominator: 1 } },
  { dir: 'src/1/7', name: 'Foundation', target: 'Consciousness', ratio: '1/7', multiplier1: { numerator: 11, denominator: 10 }, multiplier2: { numerator: 1, denominator: 1 } },
  { dir: 'src/1/8', name: 'Foundation', target: 'Void', ratio: '1/8', multiplier1: { numerator: 11, denominator: 10 }, multiplier2: { numerator: 8, denominator: 7 } },
  { dir: 'src/1/2', name: 'Foundation', target: 'Vortex', ratio: '1/2', multiplier1: { numerator: 11, denominator: 10 }, multiplier2: { numerator: 6, denominator: 5 } },
  { dir: 'src/1/5', name: 'Foundation', target: 'Sacred Geometry', ratio: '1/5', multiplier1: { numerator: 11, denominator: 10 }, multiplier2: { numerator: 5, denominator: 4 } },
  { dir: 'src/8/7', name: 'Void', target: 'Consciousness', ratio: '8/7', multiplier1: { numerator: 8, denominator: 7 }, multiplier2: { numerator: 1, denominator: 1 } },
  { dir: 'src/8/2', name: 'Void', target: 'Vortex', ratio: '8/2', multiplier1: { numerator: 8, denominator: 7 }, multiplier2: { numerator: 6, denominator: 5 } },
  { dir: 'src/8/5', name: 'Void', target: 'Sacred Geometry', ratio: '8/5', multiplier1: { numerator: 8, denominator: 7 }, multiplier2: { numerator: 5, denominator: 4 } },
  { dir: 'src/4/0', name: 'Constants', target: 'ZeroPoint', ratio: '4/0', multiplier1: { numerator: 11, denominator: 10 }, multiplier2: { numerator: 0, denominator: 1 } },
  { dir: 'src/4/7', name: 'Constants', target: 'Consciousness', ratio: '4/7', multiplier1: { numerator: 11, denominator: 10 }, multiplier2: { numerator: 1, denominator: 1 } },
  { dir: 'src/4/8', name: 'Constants', target: 'Void', ratio: '4/8', multiplier1: { numerator: 11, denominator: 10 }, multiplier2: { numerator: 8, denominator: 7 } },
  { dir: 'src/4/2', name: 'Constants', target: 'Vortex', ratio: '4/2', multiplier1: { numerator: 11, denominator: 10 }, multiplier2: { numerator: 6, denominator: 5 } },
  { dir: 'src/3/9', name: 'Creative Resonance', target: 'Unity', ratio: '3/9', multiplier1: { numerator: 3, denominator: 2 }, multiplier2: { numerator: 1, denominator: 1 } },
  { dir: 'src/2/7', name: 'Vortex', target: 'Consciousness', ratio: '2/7', multiplier1: { numerator: 6, denominator: 5 }, multiplier2: { numerator: 1, denominator: 1 } },
  { dir: 'src/2/8', name: 'Vortex', target: 'Void', ratio: '2/8', multiplier1: { numerator: 6, denominator: 5 }, multiplier2: { numerator: 8, denominator: 7 } },
  { dir: 'src/2/5', name: 'Vortex', target: 'Sacred Geometry', ratio: '2/5', multiplier1: { numerator: 6, denominator: 5 }, multiplier2: { numerator: 5, denominator: 4 } },
  { dir: 'src/5/7', name: 'Sacred Geometry', target: 'Consciousness', ratio: '5/7', multiplier1: { numerator: 5, denominator: 4 }, multiplier2: { numerator: 1, denominator: 1 } },
  { dir: 'src/5/8', name: 'Sacred Geometry', target: 'Void', ratio: '5/8', multiplier1: { numerator: 5, denominator: 4 }, multiplier2: { numerator: 8, denominator: 7 } },
  { dir: 'src/5/2', name: 'Sacred Geometry', target: 'Vortex', ratio: '5/2', multiplier1: { numerator: 5, denominator: 4 }, multiplier2: { numerator: 6, denominator: 5 } }
];
