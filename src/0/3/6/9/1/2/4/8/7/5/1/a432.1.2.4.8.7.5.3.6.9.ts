// a432.1.2.4.8.7.5.3.6.9.ts — Full Vortex Address Module
// GENERATED by scripts/a432-orbit-fill.mjs from the shortest existing member; do not edit by hand.
//
// This module holds the first 9 digits of the full vortex sequence
// 1-2-4-8-7-5-3-6-9: the doubling orbit 1-2-4-8-7-5 followed by the axis.
//
...
//
// The tail past the orbit here is 3-6-9.
...
export function getVortexSequence(length = 9): readonly number[] {
...
export function getVortexNth(index = 0): number {
  const d = CYCLE[index]
  if (d === undefined) throw new Error(`a432.1.2.4.8.7.5.3.6.9: no digit at position ${index}`)
  return d
}
...
export const a432VortexAddress = {
  address: '1.2.4.8.7.5.3.6.9',
  sequence: getVortexSequence,
  nth: getVortexNth,
  orbitLength: VORTEX_ORBIT_LENGTH,
  doc: `The first 9 digits of the full vortex 1-2-4-8-7-5-3-6-9: the doubling orbit, then the axis. Doubling alone does not reach the axis.`,
}
