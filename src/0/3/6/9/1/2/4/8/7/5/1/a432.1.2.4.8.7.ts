// a432.1.2.4.8.7.ts — Open Vortex/Doubling Stream Module (Short Arc)
//
// This module encodes the open doubling sequence (1-2-4-8-7) as a living, recursive stream.
// It is the generative arc of the vortex, not yet returned to origin. All logic is self-contained.

/**
 * Metaphysical Principle:
 * - The sequence 1→2→4→8→7 is the open right-hand vortex in vortex math, truncated before further progression.
...
function* openDoublingVortexStream(start = 1, length = 5) {
  let n = start;
...
function getOpenDoublingSequence(start = 1, length = 5) {
...
// --- Example Usage ---
const openSequence = getOpenDoublingSequence(); // [1,2,4,8,7]
...
const a432OpenDoublingVortex = {
  ...
  open: openSequence,
  doc: `This module encodes the open, generative doubling vortex (1-2-4-8-7) as a stream, generator, and proof. It is the journey before closure in the A432 matrix.`
};
