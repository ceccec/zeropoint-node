// a432.1.2.4.8.7.ts — Open Vortex/Doubling Stream Module
 ...
 * - The sequence 1→2→4→8→7 is the open right-hand vortex in vortex math, truncated before closure.
...
const a432OpenDoublingVortex = {
  ...
  open: openSequence,
  doc: `This module encodes the open, generative doubling vortex (1-2-4-8-7) as a stream, generator, and proof. It is the seed of the A432 matrix.`
};
