 ...
 * - The sequence 1→2→4 is the open right-hand vortex in vortex math, truncated before further progression.
...
function getOpenDoublingSequence(start = 1, length = 3) {
...
// --- Example Usage ---
const openSequence = getOpenDoublingSequence(); // [1,2,4]
...
const a432OpenDoublingVortex = {
  ...
  open: openSequence,
  doc: `This module encodes the open, generative doubling vortex (1-2-4) as a stream, generator, and proof. It is the journey before closure in the A432 matrix.`
};
