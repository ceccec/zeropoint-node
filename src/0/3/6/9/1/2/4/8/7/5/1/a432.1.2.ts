// a432.1.2.ts — Open Vortex/Doubling Stream Module (Minimal Arc)
//
// This module encodes the open doubling sequence (1-2) as a living, recursive stream.
 ...
 * - The sequence 1→2 is the open right-hand vortex in vortex math, truncated before further progression.
...
function* openDoublingVortexStream(start = 1, length = 2) {
  let n = start;
...
function getOpenDoublingSequence(start = 1, length = 2) {
...
// --- Example Usage ---
const openSequence = getOpenDoublingSequence(); // [1,2]
...
const a432OpenDoublingVortex = {
  ...
  open: openSequence,
  doc: `This module encodes the open, generative doubling vortex (1-2) as a stream, generator, and proof. It is the journey before closure in the A432 matrix.`
};
