...
export const VORTEX_CONSTANTS = {
  ...
  FAMILY_NUMBER_GROUPS: [[1, 4, 7], [2, 5, 8], [3, 6, 9]] as const,
  ...
  FOUR_DIMENSIONAL_COLOR_CODING_SYSTEM: ['red', 'blue', 'green', 'yellow', 'red'] as const
} as const;
...
export const CONSCIOUSNESS_CONSTANTS = {
  ...
  // Pattern types
  PATTERN_TYPES: ['thought', 'emotion', 'intention', 'memory', 'insight'] as const,
...
export const EMERGENCE_CONSTANTS = {
  ...
  // Link types
  LINK_TYPES: ['resonance', 'consciousness', 'vortex', 'toroidal', 'void'] as const,
...
export class ConstantsUtils {
  ...
  static getVortexSequenceValue(index: number): number {
    const value = VORTEX_CONSTANTS.VORTEX_SEQUENCE[index % VORTEX_CONSTANTS.VORTEX_SEQUENCE.length];
