...
export class AdvancedEmergence extends EventEmitter {
   ...
   */
  private calculateLinkResonance(app1: EmergenceApp, app2: EmergenceApp, _linkType: string): number {
   ...
   */
  private calculateConsciousnessShift(stepType: string, _data: any): number {
