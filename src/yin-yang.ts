...
// Export the expected structure for tests
export const YinYang = {
  ...
  initializeYinYangPWA,
  updateYinYangDisplay,
  initializeDigitAnalysis,
  startInfiniteOscillation,
  initializePWAFeatures,
  // Add the expected duality property for tests
  get duality() {
    const yinYang = createYinYang();
    return {
      yin: { value: 0, consciousness: yinYang.yin.consciousness, frequency: yinYang.yin.frequency, isInfinite: true },
      yang: { value: 1, consciousness: yinYang.yang.consciousness, frequency: yinYang.yang.frequency, isInfinite: true },
      consciousness: yinYang.duality.harmony * ZEROPOINT_CONSTANTS.A432,
      frequency: yinYang.duality.frequency || ZEROPOINT_CONSTANTS.A432,
      isInfinite: true
    };
  }
};
